...
class Download extends Observable implements Runnable {
    ...
    private String location; //File Location
    ...
    public void setLocation(String l){
        this.location = new String(l);
        String fileName = url.getFile();
        this.location = this.location +fileName.substring(fileName.lastIndexOf('/') + 1);
    }
    ...
    public String getInitTime(){
        return formatTime(initTime/1000000000);
    }
    // Get elapsed time
